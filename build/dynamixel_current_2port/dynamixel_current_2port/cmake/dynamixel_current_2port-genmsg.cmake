...
get_filename_component(_filename "/home/jaemin/woojin_rnd/src/dynamixel_current_2port/dynamixel_current_2port/srv/RL_NeckAngle.srv" NAME_WE)
add_custom_target(_dynamixel_current_2port_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "dynamixel_current_2port" "/home/jaemin/woojin_rnd/src/dynamixel_current_2port/dynamixel_current_2port/srv/RL_NeckAngle.srv" ""
)

get_filename_component(_filename "/home/jaemin/woojin_rnd/src/dynamixel_current_2port/dynamixel_current_2port/srv/Select_Motion.srv" NAME_WE)
add_custom_target(_dynamixel_current_2port_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "dynamixel_current_2port" "/home/jaemin/woojin_rnd/src/dynamixel_current_2port/dynamixel_current_2port/srv/Select_Motion.srv" ""
)

get_filename_component(_filename "/home/jaemin/woojin_rnd/src/dynamixel_current_2port/dynamixel_current_2port/srv/UD_NeckAngle.srv" NAME_WE)
add_custom_target(_dynamixel_current_2port_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "dynamixel_current_2port" "/home/jaemin/woojin_rnd/src/dynamixel_current_2port/dynamixel_current_2port/srv/UD_NeckAngle.srv" ""
)

get_filename_component(_filename "/home/jaemin/woojin_rnd/src/dynamixel_current_2port/dynamixel_current_2port/srv/SendMotion.srv" NAME_WE)
add_custom_target(_dynamixel_current_2port_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "dynamixel_current_2port" "/home/jaemin/woojin_rnd/src/dynamixel_current_2port/dynamixel_current_2port/srv/SendMotion.srv" ""
)

get_filename_component(_filename "/home/jaemin/woojin_rnd/src/dynamixel_current_2port/dynamixel_current_2port/srv/Emergency.srv" NAME_WE)
add_custom_target(_dynamixel_current_2port_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "dynamixel_current_2port" "/home/jaemin/woojin_rnd/src/dynamixel_current_2port/dynamixel_current_2port/srv/Emergency.srv" ""
)

get_filename_component(_filename "/home/jaemin/woojin_rnd/src/dynamixel_current_2port/dynamixel_current_2port/srv/Turn_Angle.srv" NAME_WE)
add_custom_target(_dynamixel_current_2port_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "dynamixel_current_2port" "/home/jaemin/woojin_rnd/src/dynamixel_current_2port/dynamixel_current_2port/srv/Turn_Angle.srv" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/dynamixel_current_2port)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/dynamixel_current_2port\")")
  # install generated code
  install(
