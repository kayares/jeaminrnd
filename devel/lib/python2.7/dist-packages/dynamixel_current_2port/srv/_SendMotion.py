...
"""autogenerated by genpy from dynamixel_current_2port/SendMotionRequest.msg. Do not edit."""
import codecs
import sys
...
class SendMotionRequest(genpy.Message):
  _md5sum = "79083e8d1f250ae7086fd4d9414ac132"
  _type = "dynamixel_current_2port/SendMotionRequest"
...
"""
  __slots__ = ['SM_finish','TA_finish','UD_finish','RL_finish','EM_finish','request_id']
  _slot_types = ['bool','bool','bool','bool','bool','int32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       SM_finish,TA_finish,UD_finish,RL_finish,EM_finish,request_id
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_5Bi().pack(_x.SM_finish, _x.TA_finish, _x.UD_finish, _x.RL_finish, _x.EM_finish, _x.request_id))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.SM_finish, _x.TA_finish, _x.UD_finish, _x.RL_finish, _x.EM_finish, _x.request_id,) = _get_struct_5Bi().unpack(str[start:end])
...
def _get_struct_5Bi():
    ...
    return _struct_5Bi
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from dynamixel_current_2port/SendMotionResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class SendMotionResponse(genpy.Message):
  ...
  _type = "dynamixel_current_2port/SendMotionResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
class SendMotion(object):
  _type          = 'dynamixel_current_2port/SendMotion'
  _md5sum = 'd1639d81e320e2f0297d5f30ecc057d5'
