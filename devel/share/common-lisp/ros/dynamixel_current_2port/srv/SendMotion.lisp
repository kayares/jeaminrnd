...
(cl:defmethod cl:initialize-instance :after ((m <SendMotion-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SendMotion-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dynamixel_current_2port-srv:<SendMotion-request> is deprecated: use dynamixel_current_2port-srv:SendMotion-request instead.")))

(cl:ensure-generic-function 'SM_finish-val :lambda-list '(m))
(cl:defmethod SM_finish-val ((m <SendMotion-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamixel_current_2port-srv:SM_finish-val is deprecated.  Use dynamixel_current_2port-srv:SM_finish instead.")
  (SM_finish m))

(cl:ensure-generic-function 'TA_finish-val :lambda-list '(m))
(cl:defmethod TA_finish-val ((m <SendMotion-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamixel_current_2port-srv:TA_finish-val is deprecated.  Use dynamixel_current_2port-srv:TA_finish instead.")
  (TA_finish m))

(cl:ensure-generic-function 'UD_finish-val :lambda-list '(m))
(cl:defmethod UD_finish-val ((m <SendMotion-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamixel_current_2port-srv:UD_finish-val is deprecated.  Use dynamixel_current_2port-srv:UD_finish instead.")
  (UD_finish m))

(cl:ensure-generic-function 'RL_finish-val :lambda-list '(m))
(cl:defmethod RL_finish-val ((m <SendMotion-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamixel_current_2port-srv:RL_finish-val is deprecated.  Use dynamixel_current_2port-srv:RL_finish instead.")
  (RL_finish m))

(cl:ensure-generic-function 'EM_finish-val :lambda-list '(m))
(cl:defmethod EM_finish-val ((m <SendMotion-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamixel_current_2port-srv:EM_finish-val is deprecated.  Use dynamixel_current_2port-srv:EM_finish instead.")
  (EM_finish m))

(cl:ensure-generic-function 'request_id-val :lambda-list '(m))
(cl:defmethod request_id-val ((m <SendMotion-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamixel_current_2port-srv:request_id-val is deprecated.  Use dynamixel_current_2port-srv:request_id instead.")
  (request_id m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SendMotion-request>)))
  ...
  "dynamixel_current_2port/SendMotionRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SendMotion-request)))
  "Returns string type for a service object of type 'SendMotion-request"
  "dynamixel_current_2port/SendMotionRequest")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SendMotion-request>)))
  ...
  "d1639d81e320e2f0297d5f30ecc057d5")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SendMotion-request)))
  "Returns md5sum for a message object of type 'SendMotion-request"
  "d1639d81e320e2f0297d5f30ecc057d5")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SendMotion-request>)))
  ...
  (cl:format cl:nil "bool SM_finish~%bool TA_finish~%bool UD_finish~%bool RL_finish~%bool EM_finish~%int32 request_id # Unique request ID~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SendMotion-request)))
  "Returns full string definition for message of type 'SendMotion-request"
  (cl:format cl:nil "bool SM_finish~%bool TA_finish~%bool UD_finish~%bool RL_finish~%bool EM_finish~%int32 request_id # Unique request ID~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <SendMotion-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SendMotion-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dynamixel_current_2port-srv:<SendMotion-response> is deprecated: use dynamixel_current_2port-srv:SendMotion-response instead.")))
...
(cl:defmethod distance-val ((m <SendMotion-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamixel_current_2port-srv:distance-val is deprecated.  Use dynamixel_current_2port-srv:distance instead.")
  (distance m))
...
(cl:defmethod ud_neckangle-val ((m <SendMotion-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamixel_current_2port-srv:ud_neckangle-val is deprecated.  Use dynamixel_current_2port-srv:ud_neckangle instead.")
  (ud_neckangle m))

(cl:ensure-generic-function 'rl_neckangle-val :lambda-list '(m))
(cl:defmethod rl_neckangle-val ((m <SendMotion-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamixel_current_2port-srv:rl_neckangle-val is deprecated.  Use dynamixel_current_2port-srv:rl_neckangle instead.")
  (rl_neckangle m))

(cl:ensure-generic-function 'emergency-val :lambda-list '(m))
(cl:defmethod emergency-val ((m <SendMotion-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamixel_current_2port-srv:emergency-val is deprecated.  Use dynamixel_current_2port-srv:emergency instead.")
  (emergency m))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <SendMotion-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamixel_current_2port-srv:success-val is deprecated.  Use dynamixel_current_2port-srv:success instead.")
  (success m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SendMotion-response>)))
  ...
  "dynamixel_current_2port/SendMotionResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SendMotion-response)))
  "Returns string type for a service object of type 'SendMotion-response"
  "dynamixel_current_2port/SendMotionResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SendMotion)))
  ...
  "dynamixel_current_2port/SendMotion")